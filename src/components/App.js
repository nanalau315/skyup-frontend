...
import UserEditPostForm from "./UserContainerFolder/UserEditPostForm";
  ...
  return (
    <div className="body-div">
      ...
      <Switch>
        ...
        <Route path="/editpost">
          {currentUser ? <UserEditPostForm currentUser={currentUser} /> : "Uh-oh, you need to Login or Signup! 👀"}
        </Route>
        <Route exact path="/">
          <Home/>
        </Route>
